(() => {
  ...
  const render = () => {
    ...
    if (!quick || document.querySelector('.methodology-course')) return
    ...
    course.innerHTML = `
      ...
      <div class="methodology-course__list">
        <article class="methodology-course__lesson"><b>01</b><div><strong>География Колумбии</strong><small>Территория, население, регионы и природа · 14 мин. 44 сек.</small></div><audio controls preload="metadata" src="/audio/lesson-01-geography-full.mp3" aria-label="Полный урок География Колумбии"></audio><button class="methodology-course__start" data-topic="География">Тренировка</button></article>
        <article class="methodology-course__lesson"><b>02</b><div><strong>История Колумбии</strong><small>Полный методический блок · 14 мин. 26 сек.</small></div><audio controls preload="metadata" src="/audio/lesson-02-history-full.mp3" aria-label="Полный урок История Колумбии"></audio><button class="methodology-course__start" data-topic="История">Тренировка</button></article>
        <article class="methodology-course__lesson"><b>03</b><div><strong>Конституция и государство</strong><small>Полный методический блок · 16 мин. 33 сек.</small></div><audio controls preload="metadata" src="/audio/lesson-03-constitution-full.mp3" aria-label="Полный урок Конституция и государство"></audio><button class="methodology-course__start" data-topic="Конституция">Тренировка</button></article>
        <article class="methodology-course__lesson"><b>04</b><div><strong>Испанский язык</strong><small>Полный методический блок · 15 мин. 18 сек.</small></div><audio controls preload="metadata" src="/audio/lesson-04-spanish-full.mp3" aria-label="Полный урок Испанский язык"></audio><button class="methodology-course__start" data-topic="Испанский язык">Тренировка</button></article>
